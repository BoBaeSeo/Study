		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-4 col-md-6 order-1  order-md-2 text-center">
					<a href="Main.jsp" class="site-logo" style="font-size: 50px; font-weight: bold">
					 Main.jsp
					</a>
				</div>
			...
			<nav class="main__menu">
				<ul class="nav__menu">
					<li><a href="/MemberBoard/Main.jsp" class="menu--active">Home</a></li>
					<li><a href="/MemberBoard/board/boardList">Board</a></li>
					<li><a href="/MemberBoard/member/LoginForm.jsp">Login</a></li>
					<li><a href="/MemberBoard/member/JoinForm.jsp">Join</a></li>
				</ul>
			</nav>
		</div>
	</header>
