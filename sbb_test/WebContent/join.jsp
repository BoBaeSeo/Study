        			...
        			success: function(result){
        				if(result == "OK") {
        					$("#checkId").text("사용가능한 아이디 입니다.").css("color", "green");
        						...
        						$("#checkId").text("아이디가 중복됩니다.").css("color", "red");
        					}
        				},
        			error: function(){
        				console.log('checkUserId 연결 실패')
        				}
        ...
        <div class="content">
            ...
            <div class="contentBody">
                ...
                <table style="margin-left: auto;margin-right: auto;background-color: snow;">
                    ...
                    <tr>
                        <td>아이디</td>
                        <td><input type="text" id="userId" name="userId"><span id="checkId"></span></td>
                    </tr>
                    <tr>
                        <td>비밀번호</td>
                    ...
                    <tr>
                        <td>이메일</td>
                        <td><input type="text" id="inputEmail" name="inputEmail"> @ <input type="text" id="emailDomain" name="emailDomain"> 
                            <select id="email">
                    ...
                    <tr>
                        <td colspan="2"><button type="button" onclick="joinCheck()">등록</button> <button type="reset">취소</button></td>
                    </tr>
                </table>
            </form>
            </div>
